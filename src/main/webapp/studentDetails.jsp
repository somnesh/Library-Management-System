...
<%
	...
	System.out.println("in student details jsp : "+sessionEmail);
      ...
      <div class="container">
            <div class="navigation">
               <ul style="display: grid; padding-top: 40px;">
                  <li class="list active" style="padding-right: 6rem;">
                ...
                <a href="dashboardAdminAndLibrarian.jsp" style="color: black; font-size: 14px; padding-bottom: 0.7rem;"><span class="back"><img src="icons/arrowBack.svg" alt="back" style="height: 30px;"> Back to dashboard</span></a>
                   ...
                   <div class="content">
                     <div style="display: flex; gap: 1rem;">
                       <%
                       		PreparedStatement psmt2 = con.prepareStatement(QueryInterface.allStudentsDetails,ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
                       		...
                       		while(rs2.next())
                       		{
	                       		...
	                       		psmt3.setString(1, rs2.getString("sid"));
                       ...
                       <div id="status" hidden="hidden"></div>
                           ...
                           <table class="table" style="width: -webkit-fill-available;">
                               <tr style="position: sticky; top: 70px;">
                                   <th style="border-radius: 7px 0px 0px 7px;">Student Id</th>
                                   <th>Name</th>
                                   <th>Roll No.</th>
                                   <th>Department</th>
                                   <th>Phone No.</th>
                               ...
                               <%while(rs2.next()){ %>
                               <tr>
                                   <td><%=rs2.getString("sid") %><input type="checkbox" hidden="hidden" id="<%=size%>" name="sid" value="<%=rs2.getString("sid")%>"></td>
                                   ...
                                   <% status = rs2.getBoolean("status");
                                    ...
                                    <select name="limit-value<%=rs2.getString("sid")%>" id="limit-value" style="border-radius: 7px; padding: 4px 0px;">

      ...
      <div class="container">
            <div class="navigation">
               <ul style="display: grid; padding-top: 40px;">
                  ...
                  <li class="list active" style="padding-right: 5.4rem;">
                ...
                <a href="dashboardAdminAndLibrarian.jsp" style="color: black; font-size: 14px; padding-bottom: 0.7rem;"><span class="back"><img src="icons/arrowBack.svg" alt="back" style="height: 30px;"> Back to dashboard</span></a>
                   ...
                   <div class="content">
                     <div style="display: flex; gap: 1rem;">
                       <%
                       		PreparedStatement psmt2 = con.prepareStatement(QueryInterface.allLibrariansDetails,ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
                       ...
                       <div id="status" hidden="hidden"></div>
                           ...
                           <table class="table" style="width: -webkit-fill-available;">
                               <tr style="position: sticky; top: 70px;">
                                   <th style="border-radius: 7px 0px 0px 7px;">Librarian Id</th>
                                   <th>Name</th>
                                   <th>Email</th>
                                   <th>Phone No.</th>
                                   <th>Status</th>
                               ...
                               <%while(rs2.next()){ %>
                               <tr>
                                   <td><%=rs2.getString("Lid") %><input type="checkbox" hidden="hidden" id="<%=size%>" name="lid" value="<%=rs2.getString("Lid")%>"></td>

...
function getCookie(cName) {
	...
	if(emailCheck!=undefined || phoneCheck!=undefined || regCheck!=undefined || rollCheck!=undefined)
	{
		...
		document.getElementById("firstName").setAttribute("value",firstName);
       	...
       	document.getElementById("roll").setAttribute("value",roll);
       	document.getElementById("reg").setAttribute("value",reg);
	...
	if(regCheck==1)
	{
		console.log("reg");
		//document.getElementById("message3").innerHTML="That email is taken. Try another.";
		document.getElementById("reg").style.outline="red solid 1px";
	...
	if(rollCheck==1)
	{
		console.log("roll");
		//document.getElementById("message3").innerHTML="That email is taken. Try another.";
		document.getElementById("roll").style.outline="red solid 1px";
       	document.getElementById("roll").style.border="1px solid red";
	}
	...
	if(firstname != '')
	{
		document.getElementById("fName-msg").innerHTML = '<i style="color: green" class="fa-solid fa-circle-check"></i>'
	}
	else
	{
		document.getElementById("fName-msg").innerHTML = '<i style="color: red" class="fa-solid fa-circle-xmark"></i>'
	}
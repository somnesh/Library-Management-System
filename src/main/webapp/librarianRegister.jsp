...
<body>
        ...
        <div class="content">
            ...
            <div>
                <div class="navigation">
                  ...
                  <li class="list active"  style="padding-right: 6.4rem">
        	...
        	<div style="display: flex; padding-bottom: 1rem; gap: 13rem; align-items: center; justify-content: center;">
            	<span class="heading" style="padding-bottom: 2rem;">Create a new librarian account</span>
            </div>
            <div id="status-div" style="content-visibility: hidden;">
            	<span id="status"></span>
            </div>
            <form action="<%=request.getContextPath()%>/LibrarianRegistration" method="post">
                <div class="container">
                    <div class="columns">
                        <div class="first-col">
            ...
            <div onmousemove="check()" style="display: flex;align-items: center;height: 5rem;justify-content: center;">
                <button id="submit" type="submit" class="btn">Add Librarian</button>
            </div>
        </form>
        </div>
        </div>
    ...
    <script src="js/librarianRegisterScript.js"></script>
</body>
</html>    
